...
// Most of this code is from "lordjesus"s port of SharpNeat to Unity
// Changes will be noted.

public class Optimizer : MonoBehaviour {

    const int NUM_INPUTS = 13;						// Changed from 5 to 10 by Brandon
	...
	// Name of experiment changed by Brandon
	void Start () {
        ...
        experiment.Initialize("Horror", xmlConfig.DocumentElement, NUM_INPUTS, NUM_OUTPUTS);

        champFileSavePath = Application.persistentDataPath + string.Format("/{0}.champ.xml", "horror");
        popFileSavePath = Application.persistentDataPath + string.Format("/{0}.pop.xml", "horror");
